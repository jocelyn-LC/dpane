import { defineComponent as Tt, ref as vt, computed as St, onMounted as Ot, openBlock as hn, createElementBlock as yn, toDisplayString as wt, createCommentVNode as Rt, createElementVNode as de } from "../vue.esm-browser.prod.js";
import { D as At } from "./DPClipboard.es.js";
var gn = { exports: {} };
function bn(n) {
  return n instanceof Map ? n.clear = n.delete = n.set = function() {
    ...
    var t = n[e];
    typeof t == "object" && !Object.isFrozen(t) && bn(t);
  }), n;
}
gn.exports = bn;
gn.exports.default = bn;
class Tn {
  constructor(e) {
...
const Mt = "</span>", vn = (n) => !!n.scope || n.sublanguage && n.language, It = (n, { prefix: e }) => {
  if (n.includes(".")) {
    const t = n.split(".");
    return [
      `${e}${t.shift()}`,
      ...t.map((s, d) => `${s}${"_".repeat(d + 1)}`)
    ].join(" ");
  }
  return `${e}${n}`;
};
class Ct {
  ...
  openNode(e) {
    if (!vn(e))
      return;
    let t = "";
    e.sublanguage ? t = `language-${e.language}` : t = It(e.scope, { prefix: this.classPrefix }), this.span(t);
  }
  closeNode(e) {
    !vn(e) || (this.buffer += Mt);
  }
...
function _n(...n) {
  return "(" + (Lt(n).capture ? "" : "?:") + n.map((s) => fe(s)).join("|") + ")";
}
function bt(n) {
...
function mn(n, { joinWith: e }) {
  ...
  return n.map((s) => {
    ...
    for (; o.length > 0; ) {
      ...
      i += o.substring(0, r.index), o = o.substring(r.index + r[0].length), r[0][0] === "\\" && r[1] ? i += "\\" + String(Number(r[1]) + d) : (i += r[0], r[0] === "(" && t++);
    }
    return i;
  }).map((s) => `(${s})`).join(e);
}
const Pt = /\b\B/, pt = "[a-zA-Z]\\w*", En = "[a-zA-Z_]\\w*", _t = "\\b\\d+(\\.\\d+)?", mt = "(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)", Et = "\\b(0b[01]+)", Ft = "!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~", $t = (n = {}) => {
  const e = /^#![ ]*\//;
...
function ft(n, e, t = lr) {
  const s = /* @__PURE__ */ Object.create(null);
  return typeof n == "string" ? d(t, n.split(" ")) : Array.isArray(n) ? d(t, n) : Object.keys(n).forEach(function(o) {
    Object.assign(
      s,
      ft(n[o], e, o)
    );
...
function Nt(n, e, { key: t }) {
  ...
  for (let r = 1; r <= e.length; r++)
    i[r + s] = d[r], o[r + s] = !0, s += bt(e[r - 1]);
  n[t] = i, n[t]._emit = o, n[t]._multi = !0;
}
function gr(n) {
  if (!!Array.isArray(n.begin)) {
    if (n.skip || n.excludeBegin || n.returnBegin)
      throw ge("skip, excludeBegin, returnBegin not compatible with beginScope: {}"), ve;
    if (typeof n.beginScope != "object" || n.beginScope === null)
      throw ge("beginScope must be object"), ve;
    Nt(n, n.begin, { key: "beginScope" }), n.begin = mn(n.begin, { joinWith: "" });
  }
}
function br(n) {
  if (!!Array.isArray(n.end)) {
    if (n.skip || n.excludeEnd || n.returnEnd)
      throw ge("skip, excludeEnd, returnEnd not compatible with endScope: {}"), ve;
    if (typeof n.endScope != "object" || n.endScope === null)
      throw ge("endScope must be object"), ve;
    Nt(n, n.end, { key: "endScope" }), n.end = mn(n.end, { joinWith: "" });
  }
}
function pr(n) {
...
function mr(n) {
  ...
  class t {
    ...
    addRule(r, a) {
      a.position = this.position++, this.matchIndexes[this.matchAt] = a, this.regexes.push([a, r]), this.matchAt += bt(r) + 1;
    }
    compile() {
    ...
    exec(r) {
      ...
      if (!a)
        return null;
      const l = a.findIndex((u, b) => b > 0 && u !== void 0), c = this.matchIndexes[l];
      return a.splice(0, l), Object.assign(a, c);
    }
  }
  class s {
    constructor() {
    ...
    getMatcher(r) {
      ...
      const a = new t();
      return this.rules.slice(r).forEach(([l, c]) => a.addRule(l, c)), a.compile(), this.multiRegexes[r] = a, a;
    }
    ...
    exec(r) {
      ...
      if (this.resumingScanAtSamePosition() && !(l && l.index === this.lastIndex)) {
        ...
        c.lastIndex = this.lastIndex + 1, l = c.exec(r);
      }
  ...
  function o(i, r) {
    ...
    let l = null;
    return typeof i.keywords == "object" && i.keywords.$pattern && (i.keywords = Object.assign({}, i.keywords), l = i.keywords.$pattern, delete i.keywords.$pattern), l = l || /\w+/, i.keywords && (i.keywords = ft(i.keywords, n.case_insensitive)), a.keywordPatternRe = e(l, !0), r && (i.begin || (i.begin = /\B|\b/), a.beginRe = e(a.begin), !i.end && !i.endsWithParent && (i.end = /\B|\b/), i.end && (a.endRe = e(a.end)), a.terminatorEnd = fe(a.end) || "", i.endsWithParent && r.terminatorEnd && (a.terminatorEnd += (i.end ? "|" : "") + r.terminatorEnd)), i.illegal && (a.illegalRe = e(i.illegal)), i.contains || (i.contains = []), i.contains = [].concat(...i.contains.map(function(c) {
      return Er(c === "self" ? i : c);
    })), i.contains.forEach(function(c) {
      o(c, a);
    }), i.starts && o(i.starts, r), a.matcher = d(a), a;
  }
  if (n.compilerExtensions || (n.compilerExtensions = []), n.contains && n.contains.includes("self"))
    throw new Error("ERR: contains `self` is not supported at the top-level of a language.  See documentation.");
  return n.classNameAliases = ue(n.classNameAliases || {}), o(n);
}
function ht(n) {
  return n ? n.endsWithParent || ht(n.starts) : !1;
}
function Er(n) {
  return n.variants && !n.cachedVariants && (n.cachedVariants = n.variants.map(function(e) {
    return ue(n, { variants: null }, e);
  })), n.cachedVariants ? n.cachedVariants : ht(n) ? ue(n, { starts: n.starts ? ue(n.starts) : null }) : Object.isFrozen(n) ? ue(n) : n;
}
var fr = "11.7.0";
...
const Ae = ut, Rn = ue, An = Symbol("nomatch"), hr = 7, yr = function(n) {
  ...
  function l(g) {
    let h = g.className + " ";
    h += g.parentNode ? g.parentNode.className : "";
    const S = r.languageDetectRe.exec(h);
    if (S) {
      const k = C(S[1]);
      return k || (wn(o.replace("{}", S[1])), wn("Falling back to no-highlight mode for this block.", g)), k ? S[1] : "no-highlight";
    }
    return h.split(/\s+/).find((k) => a(k) || C(k));
  }
  function c(g, h, S) {
    let k = "", F = "";
    typeof h == "object" ? (k = g, S = h.ignoreIllegals, F = h.language) : (pe("10.7.0", "highlight(lang, code, ...args) has been deprecated."), pe("10.7.0", `Please use highlight(code, options) instead.
https://github.com/highlightjs/highlight.js/issues/2277`), F = g, k = h), S === void 0 && (S = !0);
    const H = {
      code: k,
      language: F
    };
  ...
  function u(g, h, S, k) {
    ...
    function J() {
      ...
      let y = v.keywordPatternRe.exec(U), O = "";
      for (; y; ) {
        O += U.substring(_, y.index);
        const x = ie.case_insensitive ? y[0].toLowerCase() : y[0], Z = H(v, x);
        if (Z) {
          const [se, we] = Z;
          if (G.addText(O), O = "", F[x] = (F[x] || 0) + 1, F[x] <= hr && (le += we), se.startsWith("_"))
            O += y[0];
          else {
            const Re = ie.classNameAliases[se] || se;
            G.addKeyword(y[0], Re);
          }
        } else
          O += y[0];
        _ = v.keywordPatternRe.lastIndex, y = v.keywordPatternRe.exec(U);
      }
      O += U.substring(_), G.addText(O);
    }
    function oe() {
      if (U === "")
        return;
      ...
      if (typeof v.subLanguage == "string") {
        ...
        _ = u(v.subLanguage, U, !0, ye[v.subLanguage]), ye[v.subLanguage] = _._top;
      } else
        _ = p(U, v.subLanguage.length ? v.subLanguage : null);
      v.relevance > 0 && (le += _.relevance), G.addSublanguage(_._emitter, _.language);
    }
    function $() {
      v.subLanguage != null ? oe() : J(), U = "";
    }
    function W(_, y) {
      let O = 1;
      const x = y.length - 1;
      for (; O <= x; ) {
        ...
        const Z = ie.classNameAliases[_[O]] || _[O], se = y[O];
        Z ? G.addKeyword(se, Z) : (U = se, J(), U = ""), O++;
      }
    }
    function Y(_, y) {
      return _.scope && typeof _.scope == "string" && G.openNode(ie.classNameAliases[_.scope] || _.scope), _.beginScope && (_.beginScope._wrap ? (G.addKeyword(U, ie.classNameAliases[_.beginScope._wrap] || _.beginScope._wrap), U = "") : _.beginScope._multi && (W(_.beginScope, y), U = "")), v = Object.create(_, { parent: { value: v } }), v;
    }
    function P(_, y, O) {
      let x = Bt(_.endRe, O);
      if (x) {
      ...
      if (_.endsWithParent)
        return P(_.parent, y, O);
    }
    function X(_) {
      return v.matcher.regexIndex === 0 ? (U += _[0], 1) : (Ee = !0, 0);
    }
    function ee(_) {
      const y = _[0], O = _.rule, x = new Tn(O), Z = [O.__beforeBegin, O["on:begin"]];
      for (const se of Z)
        if (!!se && (se(_, x), x.isMatchIgnored))
          return X(y);
      return O.skip ? U += y : (O.excludeBegin && (U += y), $(), !O.returnBegin && !O.excludeBegin && (U = y)), Y(O, _), O.returnBegin ? 0 : y.length;
    }
    function te(_) {
      const y = _[0], O = h.substring(_.index), x = P(v, _, O);
      if (!x)
        return An;
      const Z = v;
      v.endScope && v.endScope._wrap ? ($(), G.addKeyword(y, v.endScope._wrap)) : v.endScope && v.endScope._multi ? ($(), W(v.endScope, _)) : Z.skip ? U += y : (Z.returnEnd || Z.excludeEnd || (U += y), $(), Z.excludeEnd && (U = y));
      do
        v.scope && G.closeNode(), !v.skip && !v.subLanguage && (le += v.relevance), v = v.parent;
      while (v !== x.parent);
      return x.starts && Y(x.starts, _), Z.returnEnd ? 0 : y.length;
    }
    function re() {
      const _ = [];
      for (let y = v; y !== ie; y = y.parent)
    ...
    function ce(_, y) {
      ...
      if (U += _, O == null)
        return $(), 0;
      if (ae.type === "begin" && y.type === "end" && ae.index === y.index && O === "") {
        if (U += h.slice(y.index, y.index + 1), !d) {
      ...
      if (ae = y, y.type === "begin")
        return ee(y);
      if (y.type === "illegal" && !S) {
        const x = new Error('Illegal lexeme "' + O + '" for mode "' + (v.scope || "<unnamed>") + '"');
        throw x.mode = v, x;
      } else if (y.type === "end") {
        const x = te(y);
        if (x !== An)
    ...
    const Oe = mr(ie);
    let _e = "", v = k || Oe;
    const ye = {}, G = new r.__emitter(r);
    re();
    let U = "", le = 0, j = 0, me = 0, Ee = !1;
    try {
      for (v.matcher.considerAll(); ; ) {
        me++, Ee ? Ee = !1 : v.matcher.considerAll(), v.matcher.lastIndex = j;
        const _ = v.matcher.exec(h);
        if (!_)
          break;
        const y = h.substring(j, _.index), O = ce(y, _);
        j = _.index + O;
      }
      return ce(h.substring(j)), G.closeAllNodes(), G.finalize(), _e = G.toHTML(), {
        language: g,
        value: _e,
        relevance: le,
        illegal: !1,
  ...
  function b(g) {
    ...
    return h._emitter.addText(g), h;
  }
  function p(g, h) {
    h = h || r.languages || Object.keys(e);
    const S = b(g), k = h.filter(C).filter(B).map(
      ($) => u($, g, !1)
    );
    k.unshift(S);
    const F = k.sort(($, W) => {
  ...
  function E(g) {
    ...
    h = g;
    const k = h.textContent, F = S ? c(k, { language: S, ignoreIllegals: !0 }) : p(k);
  ...
  const f = () => {
    M(), pe("10.6.0", "initHighlighting() deprecated.  Use highlightAll() now.");
  };
  function A() {
    M(), pe("10.6.0", "initHighlightingOnLoad() deprecated.  Use highlightAll() now.");
  }
  let R = !1;
  function M() {
  ...
  function L(g, h) {
    ...
    try {
      ...
      if (ge("Language definition for '{}' could not be registered.".replace("{}", g)), d)
        ge(k);
      else
        throw k;
      S = i;
    }
    S.name || (S.name = g), e[g] = S, S.rawDefinition = h.bind(null, n), S.aliases && q(S.aliases, { languageName: g });
  }
  function D(g) {
    delete e[g];
  ...
  function ne(g) {
    g["before:highlightBlock"] && !g["before:highlightElement"] && (g["before:highlightElement"] = (h) => {
      g["before:highlightBlock"](
        Object.assign({ block: h.el }, h)
      );
    }), g["after:highlightBlock"] && !g["after:highlightElement"] && (g["after:highlightElement"] = (h) => {
  ...
  function V(g) {
    return pe("10.7.0", "highlightBlock will be removed entirely in v12.0"), pe("10.7.0", "Please use highlightElement now."), E(g);
  }
  Object.assign(n, {
    highlight: c,
    highlightAuto: p,
  ...
  for (const g in Te)
    typeof Te[g] == "object" && gn.exports(Te[g]);
  return Object.assign(n, Te), n;
};
var he = yr({}), Tr = he;
he.HighlightJS = he;
he.default = he;
...
function vr() {
  ...
  Mn = 1;
  function n(e) {
    const t = e.regex, s = t.concat(/[\p{L}_]/u, t.optional(/[\p{L}0-9_.-]*:/u), /[\p{L}0-9_.-]*/u), d = /[\p{L}0-9._:-]+/u, o = {
      className: "symbol",
    ...
    }), a = e.inherit(e.APOS_STRING_MODE, { className: "string" }), l = e.inherit(e.QUOTE_STRING_MODE, { className: "string" }), c = {
      endsWithParent: !0,
      illegal: /</,
      relevance: 0,
      contains: [
...
function Or() {
  ...
  Cn = 1;
  function n(e) {
    const t = e.regex, s = e.COMMENT("//", "$", { contains: [{ begin: /\\\n/ }] }), d = "decltype\\(auto\\)", o = "[a-zA-Z_]\\w*::", i = "<[^<>]+>", r = "(" + d + "|" + t.optional(o) + "[a-zA-Z_]\\w*" + t.optional(i) + ")", a = {
      className: "type",
      variants: [
        { begin: "\\b[a-z\\d_]*_t\\b" },
...
function wr() {
  ...
  kn = 1;
  function n(e) {
    const t = e.regex, s = e.COMMENT("//", "$", { contains: [{ begin: /\\\n/ }] }), d = "decltype\\(auto\\)", o = "[a-zA-Z_]\\w*::", i = "<[^<>]+>", r = "(?!struct)(" + d + "|" + t.optional(o) + "[a-zA-Z_]\\w*" + t.optional(i) + ")", a = {
      className: "type",
      begin: "\\b[a-z\\d_]*_t\\b"
    }, l = "\\\\(x[0-9A-Fa-f]{2}|u[0-9A-Fa-f]{4,8}|[0-7]{3}|\\S)", c = {
      className: "string",
...
function Ar() {
  ...
  function i(r) {
    const a = r.regex, l = n(r), c = { begin: /-(webkit|moz|ms|o)-(?=[a-z])/ }, u = "and or not only", b = /@-?\w[\w]*(-\w+)*/, p = "[a-zA-Z-][a-zA-Z0-9_-]*", m = [
      r.APOS_STRING_MODE,
      r.QUOTE_STRING_MODE
    ];
    return {
...
function Mr() {
  ...
  function n(e) {
    ...
    }, b = e.inherit(c, { contains: [] }), p = e.inherit(u, { contains: [] });
    c.contains.push(p), u.contains.push(b);
    let m = [
      s,
      l
    ];
...
function Cr() {
  ...
  Un = 1;
  function n(e) {
    const t = e.regex, s = "([a-zA-Z_]\\w*[!?=]?|[-+~]@|<<|>>|=~|===?|<=>|[<>]=?|\\*\\*|[-/+%^&*~`|]|\\[\\]=?)", d = t.either(
      /\b([A-Z]+[a-z0-9]+)+/,
      /\b([A-Z]+[a-z0-9]+)+[A-Z]+/
    ), o = t.concat(d, /(::\w+)*/), r = {
      "variable.constant": [
    ...
    u.contains = D, N.contains = D;
    const T = "[>?]>", C = "[\\w#]+\\(\\w+\\):\\d+:\\d+[>*]", q = "(\\w+-)?\\d+\\.\\d+\\.\\d+(p\\d+)?[^\\d][^>]+>", B = [
      {
        begin: /^\s*=>/,
        starts: {
          end: "$",
    ...
    return c.unshift(l), {
      ...
      keywords: r,
      illegal: /\/\*/,
      contains: [e.SHEBANG({ binary: "ruby" })].concat(B).concat(c).concat(D)
    };
  }
  return Ue = n, Ue;
}
...
function Lr() {
  ...
  function d(i, r, a) {
    return a === -1 ? "" : i.replace(r, (l) => d(i, r, a - 1));
  }
  function o(i) {
    const r = i.regex, a = "[\xC0-\u02B8a-zA-Z_$][\xC0-\u02B8a-zA-Z_$0-9]*", l = a + d("(?:<" + a + "~~~(?:\\s*,\\s*" + a + "~~~)*>)?", /~~~/g, 2), m = {
      keyword: [
        "synchronized",
        "abstract",
        "private",
...
function Pr() {
  ...
  function d(o) {
    ...
    return f.variants[1].contains = [N], N.variants[1].contains = [f], {
      name: "Kotlin",
      aliases: [
        "kt",
        "kts"
...
function Fr() {
  ...
  const n = (a) => ({
    ...
    "writing-mode",
    "z-index"
  ].reverse(), i = s.concat(d);
  function r(a) {
    const l = n(a), c = i, u = "and or not only", b = "[\\w-]+", p = "(" + b + "|@\\{" + b + "\\})", m = [], E = [], N = function(B) {
      return {
        className: "string",
        begin: "~?" + B + ".*?" + B
      };
      ...
      },
      {
        ...
        contains: [
          e.HASH_COMMENT_MODE,
          {
            className: "regexp",
            variants: [
              { begin: u("s|tr|y", t.either(...c, { capture: !0 })) },
              { begin: u("s|tr|y", "\\(", "\\)") },
              { begin: u("s|tr|y", "\\[", "\\]") },
              { begin: u("s|tr|y", "\\{", "\\}") }
            ],
          ...
          },
          {
            ...
            variants: [
              ...
              { begin: b("(?:m|qr)?", /\//, /\//) },
              { begin: b("m|qr", t.either(...c, { capture: !0 }), /\1/) },
              { begin: b("m|qr", /\(/, /\)/) },
              { begin: b("m|qr", /\[/, /\]/) },
              { begin: b("m|qr", /\{/, /\}/) }
            ]
...
function Gr() {
  ...
  Xn = 1;
  function n(e) {
    const t = e.regex, s = /(?![A-Za-z0-9])(?![$])/, d = t.concat(
      ...
      match: [
        /\b/,
        t.concat("(?!fn\\b|function\\b|", M(N).join("\\b|"), "|", M(f).join("\\b|"), "\\b)"),
        d,
        t.concat(b, "*"),
        t.lookahead(/(?=\()/)
      ],
...
function Yr() {
  ...
  jn = 1;
  function n(e) {
    const t = e.regex, s = /[\p{XID_Start}_]\p{XID_Continue}*/u, d = [
      "and",
      "as",
      "assert",
      "async",
    ...
    }, p = "[0-9](_?[0-9])*", m = `(\\b(${p}))?\\.(${p})|\\b(${p})\\.`, E = `\\b|${d.join("|")}`, N = {
      className: "number",
      relevance: 0,
      variants: [
        {
          begin: `(\\b(${p})|(${m}))[eE][+-]?(${p})[jJ]?(?=${E})`
        },
        {
          begin: `(${m})[jJ]?`
        },
...
function Vr() {
  ...
  nt = 1;
  function n(e) {
    const t = e.regex, s = /(?:(?:[a-zA-Z]|\.[._a-zA-Z])[._a-zA-Z0-9]*)|\.(?!\d)/, d = t.either(
...
function Xr() {
  ...
  function n(e) {
    ...
    }, d = "([ui](8|16|32|64|128|size)|f(32|64))?", o = [
      "abstract",
      "as",
      "async",
      "await",
...
function Qr() {
  ...
  function i(r) {
    const a = n(r), l = d, c = s, u = "@[a-z-]+", b = "and or not only", m = {
      className: "variable",
...
function jr() {
  ...
  function n(e) {
    ...
    function R(M, {
      ...
      const D = L;
      return I = I || [], M.map((T) => T.match(/\|\d+$/) || I.includes(T) ? T : D(T) ? `${T}|0` : T);
    }
    return {
      name: "SQL",
      case_insensitive: !0,
...
function ea() {
  ...
  function t(...T) {
    return T.map((q) => n(q)).join("");
  }
  function s(T) {
    const C = T[T.length - 1];
    return typeof C == "object" && C.constructor === Object ? (T.splice(T.length - 1, 1), C) : {};
  }
  function d(...T) {
    return "(" + (s(T).capture ? "" : "?:") + T.map((B) => n(B)).join("|") + ")";
  }
  const o = (T) => t(
    /\b/,
    T,
  ...
  function D(T) {
    const C = {
      ...
      match: t(/\./, d(...l)),
      relevance: 0
    }, z = l.filter((K) => typeof K == "string").concat(["_|0"]), V = l.filter((K) => typeof K != "string").concat(a).map(o), g = { variants: [
      {
        className: "keyword",
        match: d(...V, ...r)
      }
    ...
    for (const K of ce.variants) {
      const fn = K.contains.find((yt) => yt.label === "interpol");
      fn.keywords = h;
      const Nn = [
        ...S,
        ...H,
...
function na() {
  ...
  ot = 1;
  function n(e) {
    const t = "true false yes no null", s = "[\\w#;/?:@&=+$,.~*'()[\\]]+", d = {
      className: "attr",
      variants: [
        { begin: "\\w[\\w :\\/.-]*:(?=[ 	]|$)" },
        {
      ...
      { begin: /[^\s,{}[\]]+/ }
    ] }), a = "[0-9]{4}(-[0-9][0-9]){0,2}", l = "([Tt \\t][0-9][0-9]?(:[0-9][0-9]){2})?", c = "(\\.[0-9]*)?", u = "([ \\t])*(Z|[-+][0-9][0-9]?(:[0-9][0-9])?)?", b = {
      className: "number",
      begin: "\\b" + a + l + c + u + "\\b"
    }, p = {
      end: ",",
...
function ta() {
  ...
  function a(c) {
    ...
    return {
      ...
      aliases: ["js", "jsx", "mjs", "cjs"],
      keywords: f,
      exports: { PARAMS_CONTAINS: z, CLASS_REFERENCE: h },
      illegal: /#(?![$_A-z])/,
      contains: [
        c.SHEBANG({
          label: "shebang",
        ...
        },
        {
          ...
          contains: [
            V,
            c.inherit(c.TITLE_MODE, { begin: p, className: "title.function" })
          ]
        },
        {
          match: /\.\.\./,
...
function ra() {
  ...
  function n(e) {
    ...
    }, o = /\d{1,2}\/\d{1,2}\/\d{4}/, i = /\d{4}-\d{1,2}-\d{1,2}/, r = /(\d|1[012])(:\d+){0,2} *(AM|PM)/, a = /\d{1,2}(:\d{1,2}){1,2}/, l = {
      className: "literal",
      variants: [
        {
...
var w = Tr;
w.registerLanguage("xml", vr());
w.registerLanguage("bash", Sr());
w.registerLanguage("c", Or());
w.registerLanguage("cpp", wr());
w.registerLanguage("csharp", Rr());
w.registerLanguage("css", Ar());
w.registerLanguage("markdown", Mr());
w.registerLanguage("diff", Ir());
w.registerLanguage("ruby", Cr());
w.registerLanguage("go", kr());
w.registerLanguage("graphql", xr());
w.registerLanguage("ini", Dr());
w.registerLanguage("java", Lr());
w.registerLanguage("javascript", Br());
w.registerLanguage("json", Ur());
w.registerLanguage("kotlin", Pr());
w.registerLanguage("less", Fr());
w.registerLanguage("lua", $r());
w.registerLanguage("makefile", zr());
w.registerLanguage("perl", Kr());
w.registerLanguage("objectivec", qr());
w.registerLanguage("php", Gr());
w.registerLanguage("php-template", Hr());
w.registerLanguage("plaintext", Wr());
w.registerLanguage("python", Yr());
w.registerLanguage("python-repl", Zr());
w.registerLanguage("r", Vr());
w.registerLanguage("rust", Xr());
w.registerLanguage("scss", Qr());
w.registerLanguage("shell", Jr());
w.registerLanguage("sql", jr());
w.registerLanguage("swift", ea());
w.registerLanguage("yaml", na());
w.registerLanguage("typescript", ta());
w.registerLanguage("vbnet", ra());
w.registerLanguage("wasm", aa());
w.HighlightJS = w;
w.default = w;
var ia = w;
const sa = ia, oa = /* @__PURE__ */ de("link", {
  rel: "stylesheet",
  href: "/static/report/index.css"
}, null, -1), ca = /* @__PURE__ */ de("link", {
  rel: "stylesheet",
  href: "/static/report/tailwind.css"
}, null, -1), la = {
  key: 0,
  class: "text-gray-500 pt-4"
}, da = { class: "mt-2" }, ua = { class: "relative" }, ga = {
  id: "code",
  class: "border border-gray-200 rounded-lg p-2"
}, ba = ["innerHTML"], pa = /* @__PURE__ */ Tt({
  __name: "CodeCopyField.ce",
  props: {
  ...
  setup(n) {
    const e = n, t = vt(), s = St(() => e.content.replace(/\\"/g, '"')), d = () => {
      At.copyOnce(s.value);
    };
    return Ot(() => {
      t.value = sa.highlight(s.value, {
        language: e.language
      }).value;
    }), (o, i) => (hn(), yn("div", null, [
      oa,
      ca,
      e.title ? (hn(), yn("div", la, wt(e.title), 1)) : Rt("", !0),
      de("div", da, [
        de("div", ua, [
          de("span", null, [
            de("button", {
          ...
          de("div", ga, [
            de("pre", { innerHTML: t.value }, null, 8, ba)
          ])
        ])
      ])
    ]));
  }
}), _a = `.hljs{background:white!important}pre{@apply w-full;}
`, ma = (n, e) => {
  const t = n.__vccOpts || n;
  for (const [s, d] of e)
    t[s] = d;
  return t;
}, Na = /* @__PURE__ */ ma(pa, [["styles", [_a]]]);
export {
  Na as default
};
